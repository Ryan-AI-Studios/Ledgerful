...
// 0262: public command-barrel names stay `crate::commands::verify::…`.
pub use crate::verify::signatures::{
...
/// Pure `decide_signature_exit` and the numeric consts live in
/// `crate::verify::signatures::sig_exit`.
pub mod sig_exit {
    pub use crate::verify::signatures::sig_exit::{
        INVALID_OR_CHAIN, OK, POLICY, UNSIGNED, decide_signature_exit,
    };
