...
pub use dead_code::{
    ...
    DEAD_CODE_SCOPE_LINE, print_dead_code_explanation, print_dead_code_explanation_struct,
    print_dead_code_grouped, print_dead_code_omit_footer, print_dead_code_scope_line,
    print_dead_code_summary,
};
