...
- **Surfaces inventory**: `ledgerful surfaces` (alias `tour`) lists which advanced surfaces are ready, empty, or gated by coverage. Read-only; does not enable coverage.
